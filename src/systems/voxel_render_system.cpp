...
void Voxel_Render_System::free_memory() {
    vkDestroyPipelineLayout(ce_device.device(), pipeline_layout, nullptr);
}

Voxel_Render_System::Voxel_Render_System(My_Engine_Device& device) : ce_device{device} {
    
}

void Voxel_Render_System::initialize_renderer(VkRenderPass render_pass, VkDescriptorSetLayout global_descriptor_set_layout){
    create_pipeline_layout(global_descriptor_set_layout);
    create_pipeline(render_pass);

}

void Voxel_Render_System::create_pipeline_layout(VkDescriptorSetLayout global_descriptor_set_layout) {
...
void Voxel_Render_System::create_pipeline(VkRenderPass render_pass) {
...
void Voxel_Render_System::render_voxels(CE_Frame_Info& frame_info) {
