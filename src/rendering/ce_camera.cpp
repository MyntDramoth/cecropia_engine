...
void CE_Camera::set_orthographic_projection(float left, float right, float top, float bottom, float near, float far) {
...
void CE_Camera::set_perspective_projection(float fov_y, float aspect_ratio, float near, float far) {
...
void CE_Camera::set_view_direction(glm::vec3 position, glm::vec3 direction, glm::vec3 up) {
...
void CE_Camera::set_view_target(glm::vec3 position, glm::vec3 target, glm::vec3 up) {
	set_view_direction(position, target - position, up);
}

void CE_Camera::set_view_YXZ(glm::vec3 position, glm::vec3 rotation) {
