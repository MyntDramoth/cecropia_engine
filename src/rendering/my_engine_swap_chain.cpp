...
MyEngineSwapChain::MyEngineSwapChain(My_Engine_Device&deviceRef, VkExtent2D extent)
    : device{deviceRef}, windowExtent{extent} {
    init();
}

MyEngineSwapChain::MyEngineSwapChain(My_Engine_Device& deviceRef, VkExtent2D extent, std::shared_ptr<MyEngineSwapChain> previous)
...
void MyEngineSwapChain::createDepthResources() {
  ...
  swapchain_depth_format = depthFormat;
  VkExtent2D swapChainExtent = getSwapChainExtent();
